...
y = (df["wdl"]==2)*1
m = Sequential()
m.add(Conv2D(6, (5, 5), activation='relu', input_shape=(8,8,3), padding="same"))
...
hist = m.fit(X, y, batch_size=1024, epochs=20)
y_train = m.predict(X, batch_size=1024, verbose=1)
...
hist2 = m.fit(X, y, batch_size=1024*8, epochs=50000)
